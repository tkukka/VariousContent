//#include <stdlib.h>
#include <cassert>    /* assert-makro/funktio */
...
void make_string_presentation(unsigned long number)
    ...
    if (number == 0 )  /* Nollan muunnos on erikoistapaus */
        {
        FooStack::push_to_stack(NUMBERS_0_19[0]);
        return;
        }
            ...
            if (group_val != 0) /* Vain nollasta eroava ryhmän lukuarvo
                ...
                if (t > 0)
                    ...
                    if (group_val == 1)
                        { /* Tuhatluvun kerroin on yksi.
                           ...
                           */
                        FooStack::push_to_stack(THOUSAND_BY_EXP[t]);
                         ...
                         */
                        FooStack::push_to_stack(THOUSANDS_BY_EXP[t]);
                        }
                    } /* t > 0 */
                ...
                if ( last_2 <= 19 ) /* x00...x19 -loppuiset erikoistapaukset*/
                    ...
                    if(last_2 != 0) /* Estetään "nolla"-teksti */
                        ...
                        FooStack::push_to_stack(NUMBERS_0_19[last_2]);
                        }
                    ...
                    if (group_val % 10 != 0 )
                        ...
                        FooStack::push_to_stack(NUMBERS_0_19[group_val % 10]);
                        }
                    /* Käsitellään (monikolliset) kymmenet */
                    group_val /= 10;
                    /* Teksti: "kymmentä" */
                    FooStack::push_to_stack(TENS);
                ...
                if (group_val == 1) /* Tasan yksi sata? */
                    {  /* Teksti: "sata" */
                    FooStack::push_to_stack(ONE_HUNDRED);
                    }
                else if (group_val > 1)   /* Muut satalukemat */
                    { /* Teksti: "sataa" */
                    FooStack::push_to_stack(HUNDREDS);
                    /* Satojen kerrointeksti "kaksi"..."yhdeksän" */
                    FooStack::push_to_stack(NUMBERS_0_19[group_val]);
                    }
